    ...
    return (
        <nav className='flex items-center justify-between flex-wrap bg-teal-500 p-6'>
            ...
            <div className="block">
                <button 
                    onClick={ dropDown } 
                    className="flex items-center px-3 py-2 text-teal-200 border 
                    rounded border-teal-400 hover:text-white hover:border-white"
                    >
            ...
            { isVisible ? 
                (<div className="w-full block flex-grow items-center">
                    <div className='text-small lg:flex-grow'>
